...
<form id="client-form" method="post" autocomplete="off">
    ...
    <div class="row d-flex justify-content-center mt-3">
        <div class="col-md-10">
            <p class="h3 text-center text-danger">Please rate our service under each specific dimensions in a scale of 1 to 5</p>
        </div>
    </div>
    <div class="row justify-content-center mt-3">
        <div class="col-md-4">
            <div class="d-flex justify-content-between">
                <p class="p-2 h5"><span>5 = Very Sartisfied</span></p><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-emoji-laughing text-success" viewBox="0 0 16 16">
            ...
            <div class="d-flex justify-content-between">
                <p class="p-2 h5"><span>3 = Neither Satisfied/Dissatisfied</span></p><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-emoji-neutral text-primary" viewBox="0 0 16 16">
                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
