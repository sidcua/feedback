...
class AdminController extends Controller
{
    public function overallRating(){
        ...
        $overallAverage = ($factors[0]->responsiveness + $factors[0]->reliability + $factors[0]->access + $factors[0]->communication + $factors[0]->cost + $factors[0]->integrity + $factors[0]->assurance + $factors[0]->outcome)/8;
        return response()->json(round($overallAverage, 2));
    }
